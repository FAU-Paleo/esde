...
subheadline: ""
title: "Summer Semester 2023 (1st Year)"
teaser: ""
header: no
image:
  caption: "The gate of the GeoZentrum main building"
permalink: "/for_students/curriculum/timetable_S2_W2023/"
breadcrumb: true
---
...
<li><a href="{{site.url}}{{site.baseurl}}/program/courses/hypothesis_testing/"> Hypothesis testing </a> is a block course between April 3-6. </li> 
<li><a href="{{site.url}}{{site.baseurl}}/program/courses/phylogenetics/"> Phylogenetics </a> includes <a href="{{site.url}}{{site.baseurl}}/program/courses/modelling/">Statistical modelling. </a></li> 
<li><a href="{{site.url}}{{site.baseurl}}/program/courses/rp_implementation/">Research Project implementation</a> is an 8 week project. </li> 
<li><a href="{{site.url}}{{site.baseurl}}/program/courses/earth_data/">Climate and Earth System Data</a> will be a block course between July 24 and 28. </li>
...
<tr>
	...
	<td></td>
	<!-- Course ***************************************************** -->
	{% assign current = site.data.courses | where: "ref", "lab_methods" %}
...
<tr>
	...
	<td></td>
	<!-- Course ***************************************************** -->
	{% assign current = site.data.courses | where: "ref", "vertebrates" %}
	{% assign currMod = site.data.modules | where: "code", current[0].module %}
	{% if currMod[0].subject contains "Paleobiology major" %} 
		{% assign bgcol = '#b6d7a8'%} 
	{% else %} 
...
<tr>
	...
	<td></td>
	<!-- Course ***************************************************** -->
	{% assign current = site.data.courses | where: "ref", "phylogenetics" %}
	{% assign currMod = site.data.modules | where: "code", current[0].module %}
	{% if currMod[0].subject contains "Paleobiology major" %} 
		{% assign bgcol = '#b6d7a8'%} 
	{% else %} 
	...
	<td></td>
	<!-- Course ***************************************************** -->
	{% assign current = site.data.courses | where: "ref", "ethics" %}
	{% assign currMod = site.data.modules | where: "code", current[0].module %}
	{% if currMod[0].subject contains "Paleobiology major" %} 
		{% assign bgcol = '#b6d7a8'%} 
	{% else %} 
...
<tr>
	...
	<!-- Course ***************************************************** -->
	{% assign current = site.data.courses | where: "ref", "analytical_paleo" %}
	{% assign currMod = site.data.modules | where: "code", current[0].module %}
	{% if currMod[0].subject contains "Paleobiology major" %} 
		{% assign bgcol = '#b6d7a8'%} 
	{% else %} 
...
<tr>
	...
	<td></td>
	<!-- Course ***************************************************** -->
	{% assign current = site.data.courses | where: "ref", "macroevolution" %}
	{% assign currMod = site.data.modules | where: "code", current[0].module %}
	{% if currMod[0].subject contains "Paleobiology major" %} 
		{% assign bgcol = '#b6d7a8'%} 
	{% else %} 
